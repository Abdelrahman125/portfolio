...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        >
            <a href="https://www.linkedin.com/in/abdelrahman-m-alnagar-336594263/">
                <i class="fa-brands fa-linkedin-in" />
            </a>
            <a href="https://github.com/Abdelrahman125">
                <i class="fa-brands fa-github" />
            </a>
        </div>
        <p class="mx-auto text-sm opacity-70">or</p> 
        <p><b class="pr-2">Email</b> abdelrahmanmoh023@gmail.com</p>
